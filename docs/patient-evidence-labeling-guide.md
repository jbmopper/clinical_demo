...
| **Free-text criterion** | Often **human_review_required**; use **insufficient_evidence** or expected indeterminate unless narrative note evidence (future scope) is in play. |
