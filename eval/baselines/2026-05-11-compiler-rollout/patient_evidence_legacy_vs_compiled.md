...
| `69e1b44cd6ec` | `none` | 5/50 | 80.0% | 40.0% | 0.0% (0/1) | 17 | (none) | (none) | fail=40 / indeterminate=5 / pass_pending_review=2 | 0 calls / $0.0000 |

## Case Rollup Movement

| Baseline | Comparison | Changed cases | Movements |
|---|---|---:|---|
| `e8efb7bcce35` | `69e1b44cd6ec` | 13 | indeterminate->fail=12 / indeterminate->pass_pending_review=1 |
