...
| `c4ccb713a2d5` | `none` | 5/50 | 80.0% | 40.0% | 0.0% (0/1) | 17 | (none) | (none) | fail=33 / indeterminate=12 / pass_pending_review=2 | 0 calls / $0.0000 |

## Case Rollup Movement

| Baseline | Comparison | Changed cases | Movements |
|---|---|---:|---|
| `e8efb7bcce35` | `c4ccb713a2d5` | 6 | indeterminate->fail=5 / indeterminate->pass_pending_review=1 |
