...
| `4a3c127baebb` | `none` | 5/50 | 80.0% | 40.0% | 0.0% (0/1) | 17 | (none) | (none) | fail=29 / indeterminate=16 / pass_pending_review=2 | 0 calls / $0.0000 |

## Case Rollup Movement

| Baseline | Comparison | Changed cases | Movements |
|---|---|---:|---|
| `500e8f14fa5a` | `4a3c127baebb` | 5 | indeterminate->fail=4 / indeterminate->pass_pending_review=1 |
