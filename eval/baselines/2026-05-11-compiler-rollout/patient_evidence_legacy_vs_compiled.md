...
| `f77c112ef220` | `none` | 5/50 | 80.0% | 40.0% | 0.0% (0/1) | 17 | (none) | (none) | fail=36 / indeterminate=9 / pass_pending_review=2 | 0 calls / $0.0000 |

## Case Rollup Movement

| Baseline | Comparison | Changed cases | Movements |
|---|---|---:|---|
| `e8efb7bcce35` | `f77c112ef220` | 9 | indeterminate->fail=8 / indeterminate->pass_pending_review=1 |
