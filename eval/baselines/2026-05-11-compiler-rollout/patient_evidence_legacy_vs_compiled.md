...
| `792ebbec7376` | `none` | 5/50 | 80.0% | 40.0% | 0.0% (0/1) | 17 | (none) | (none) | fail=30 / indeterminate=15 / pass_pending_review=2 | 0 calls / $0.0000 |

## Case Rollup Movement

| Baseline | Comparison | Changed cases | Movements |
|---|---|---:|---|
| `e8efb7bcce35` | `792ebbec7376` | 3 | indeterminate->fail=2 / indeterminate->pass_pending_review=1 |
